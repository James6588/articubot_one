...
def generate_launch_description():
    package_name = 'articubot_one'  # Ensure this is your package name
    ...
    world_file = os.path.join(get_package_share_directory('articubot_one'), 'worlds', 'obstacles.world')
